...
| **Layer** | Skill tier. Layer 1 (3) = entry points (`feature`/`fix`/`status`), Layer 2 (11) = core pipeline (PRD/design/tdd/implement/review/ship/...), Layer 3 (23) = specialized tools (arch, standards, relate, test-setup, loop tooling, settings, ...). |
